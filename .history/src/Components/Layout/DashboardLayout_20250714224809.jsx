...
const DashboardLayout = () => {
  ...
  const themeClasses = {
    ...
    sidebar: theme === 'dark' ? 'bg-emerald-700/50 border-emerald-700/50' : 'bg-emerald-100 border-emerald-300',
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        >
          <div className="flex items-center">
            <motion.button
              onClick={() => navigate('/')}
              className={`p-2 rounded-full transition ${themeClasses.btnHover}`}
              whileTap={{ scale: 0.9 }}
            >
