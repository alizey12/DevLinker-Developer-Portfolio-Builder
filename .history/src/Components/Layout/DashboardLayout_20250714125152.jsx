...
const DashboardLayout = () => {
  ...
  return (
    <div className={`flex min-h-screen ${theme === 'dark' ? 'bg-emerald-900/50 text-emerald-100' : 'bg-gray-50 text-emerald-800'}`}>
      {/* Sidebar */}
      <div className={`${isCollapsed ? 'w-20' : 'w-64'} transition-all duration-300 ${
        theme === 'dark' ? 'bg-gray-700/50 border-gray-700/50' : 'bg-white border-gray-200'
      } border-r`}>
