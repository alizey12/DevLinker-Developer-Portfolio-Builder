...
const Sidebar = ({ isCollapsed, onToggle }) => {
  return (
    <motion.div 
      ...
      className="h-screen flex flex-col bg-gradient-to-b from-emarled-900 to-emerald-800 border-r border-emerald-700"
    >
      <motion.button 
        whileHover={{ scale: 1.05 }}
        whileTap={{ scale: 0.95 }}
        onClick={onToggle} 
        className="p-4 text-cyan-900 hover:text-cyan-300 transition-all flex items-center justify-center"
      >
