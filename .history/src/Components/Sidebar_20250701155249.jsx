...
const Sidebar = () => {
  ...
  return (
    <div>
      <aside className={`${isCollapsed ? 'w-20' : 'w-64'} h-screen bg-emerald-900/70 hover:bg-emerald-700 text-white p-4 transition-all duration-300 border-r border-emerald-900/70 backdrop-blur`}>
...
<li className='className="mt-auto p-3"'>
  <NavLink to='' className="mt-auto p-3"><IoMdLogOut size={25} />
  {!isCollapsed && <span className="ml-3 font-semibold text-lg">Settings</span>}</NavLink>
</li>
