...
const Sidebar = () => {
  ...
  return (
    <div>
      <aside className={`${isCollapsed ? 'w-20' : 'w-64'} h-full bg-emerald-900/70 text-white p-4 transition-all duration-300 border-r border-emerald-900/70 backdrop-blur`}>
