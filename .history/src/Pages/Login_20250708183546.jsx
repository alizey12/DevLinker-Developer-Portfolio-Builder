        ...
        <div className="p-8">
          ...
          <form className="space-y-6" onSubmit={handleLoginSubmit}>
            ...
            <div className="relative">
              ...
              >
                <FiEyeOff className={`${themeClasses.text.secondary} hover:${themeClasses.text.secondary.replace('text', 'text-opacity-80')}`} />
              </button>
            </div>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  className={`rounded-sm ${theme === 'dark' ? 'bg-gray-700/50 border-gray-600' : 'bg-gray-50 border-gray-300'} text-${accentColor}-600 focus:ring-${accentColor}-500`}
                />
                <span className={`ml-2 text-sm ${themeClasses.text.secondary}`}>Remember me</span>
              </label>
              <a href="#" className={`text-sm ${themeClasses.text.accent} hover:${themeClasses.text.accent.replace('text', 'text-opacity-80')}`}>Forgot password?</a>
            </div>
            ...
            <div className={`text-center text-sm ${themeClasses.text.secondary}`}>
              ...
              <a href="/signup" className={`font-medium ${themeClasses.text.accent} hover:${themeClasses.text.accent.replace('text', 'text-opacity-80')}`}>
                Sign up
              </a>
            </div>
          </form>
