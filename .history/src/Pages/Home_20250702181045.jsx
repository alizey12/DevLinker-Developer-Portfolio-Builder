  ...
  return (
    <div className='w-full min-h-screen bg-emerald-950 text-white'>
      ...
      <nav className='flex items-center justify-between p-6 border-b border-emerald-900'>
        ...
        <NavLink 
          to="/contact" 
          className=' py-2 bg-emerald-600 hover:bg-emerald-700 rounded-full font-medium transition-colors duration-300'
        >
        Login
        </NavLink>
      </nav>
      ...
      <div className='container mx-auto px-6 py-16 flex flex-col md:flex-row items-center justify-between'>
        ...
        <div className='md:w-1/2 flex justify-center'>
          <div className='relative'>
            ...
            <img 
 src="https://tse4.mm.bing.net/th/id/OIP.D8eifioEnwIoj9tE-cb-uAAAAA?w=474&h=474&rs=1&pid=ImgDetMain"             alt="Front-end developer illustration"
