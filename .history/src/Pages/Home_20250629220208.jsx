...
const Home = () => {
  ...
  Turning Ideas into <span className='text-emerald-400'>Impactful Interfaces</span>
</h1>
<p className='text-lg text-emerald-200 mb-8'>
  I'm Kinza jamshaid , a passionate  <Front-end></Front-end> Developer who thrives on building responsive, user-friendly web applications. I specialize in delivering clean code, seamless UI/UX, and scalable solutions tailored to modern business needs.
</p>
