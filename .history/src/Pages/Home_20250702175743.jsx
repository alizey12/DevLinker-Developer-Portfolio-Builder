  ...
  return (
    <div className='w-full min-h-screen bg-emerald-950 text-white'>
      ...
      <div className='container mx-auto px-6 py-16 flex flex-col md:flex-row items-center justify-between'>
        ...
        {/* Image with transparent/blended effect */}
        <div className='md:w-1/2 flex justify-center relative'>
          <div className='absolute inset-0 bg-emerald-900 opacity-20 rounded-full blur-xl'></div>
          <img 
            ...
            className='w-full max-w-md relative z-10 mix-blend-lighten'
          />
        </div>
      </div>
