...
const Login = () => {
  ...
  const themeClasses = {
    ...
    button: {
      primary: `bg-${accentColor}-600 hover:bg-${accentColor}-800 ${theme === 'dark' ? 'text-white hover:bg-emerald-300' : 'text-emerald-300 hover:bg-emerald-600 hover:text-emerald-100'} transition-all duration-300 transform hover:scale-105`,
    }
  };
