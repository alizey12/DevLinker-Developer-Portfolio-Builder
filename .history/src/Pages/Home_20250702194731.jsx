...
import { FiMail, FiMessageCircle, FiDownload } from 'react-icons/fi';
const Home = () => {
  ...
  className="px-8 py-3 border border-emerald-400 hover:bg-emerald-900 rounded-full font-medium transition-all duration-300 flex items-center group"
>
