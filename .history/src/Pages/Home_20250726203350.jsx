  ...
  const themeClasses = {
    ...
    button: {
      ...
      secondary: theme === 'dark' 
        ? 'border border-emerald-200 hover:bg-emerald-800/40 text-emerald-300' 
        : 'border border-emerald-800 hover:bg-emerald-100 text-emerald-700'
    },
    hover: theme === 'dark' 
    ...
    <div className={`w-full min-h-screen ${themeClasses.bg} transition-colors duration-300`}>
      ...
      <nav className={`flex items-center justify-between p-6 border-b ${themeClasses.border}`}>
        ...
        <div className="flex gap-4">
          ...
          <NavLink 
            to="/login" 
            className={`px-6 py-2 rounded-full font-medium transition-colors duration-300 ${themeClasses.button.secondary}`}
          >
            Login
          </NavLink>
        </div>
      ...
      <div className='container mx-auto px-6 py-16'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-16'>
          {[
            ...
            <div 
              key={index} 
              className={`p-6 rounded-xl transition-all duration-300 border ${themeClasses.card} ${themeClasses.hover}`}
            >
        ...
        <div className={`py-12 border-t ${themeClasses.border}`}>
          ...
          <div className='flex flex-wrap justify-center gap-8 items-center'>
            {['React', 'JavaScript (ES6+)', 'TypeScript', 'Tailwind CSS', 'Next.js', 'Redux', 'GraphQL', 'Framer Motion'].map((tech) => (
              <div 
                key={tech} 
                className={`text-xl font-medium px-4 py-2 rounded-lg transition-colors duration-300 ${
                  theme === 'dark' 
                    ? 'bg-emerald-800/40 text-emerald-200 hover:bg-emerald-700/40' 
      ...
      <div className={`py-16 ${theme === 'dark' ? 'bg-emerald-900/30' : 'bg-emerald-100'}`}>
        <div className='container mx-auto px-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <div className={`p-8 rounded-xl border transition-all duration-300 ${themeClasses.card} ${themeClasses.hover}`}>
