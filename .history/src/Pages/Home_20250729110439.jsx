...
const Home = () => {
  ...
  const themeClasses = {
    ...
    button: {
primary: `bg-${accentColor}-600 hover:bg-${accentColor}-500 ${theme === 'dark' ? 'text-white' : 'text-white'} transition-all duration-300 transform hover:scale-105`,      secondary: theme === 'dark' 
