...
const Dashboard = () => {
  ...
  return (
    <div className="flex h-screen bg-emerald-950 text-emerald-100">
      {/* Sidebar */}
      <div className="w-20 md:w-64 bg-emerald-900/50 border-r border-emerald-800/50 p-4 flex flex-col">
        <div className="mb-8 text-center">
          <h1 className="hidden md:block text-xl font-bold text-emerald-300">DevDashboard</h1>
          <div className="md:hidden text-2xl">⚡</div>
        </div>
        
        <nav className="flex-1 space-y-2">
          <a href="#" className="flex items-center p-3 rounded-lg bg-emerald-800/50 text-emerald-200">
            <FiHome className="text-lg" />
            <span className="ml-3 hidden md:block">Dashboard</span>
          </a>
          <a href="#" className="flex items-center p-3 rounded-lg hover:bg-emerald-800/30 text-emerald-400 hover:text-emerald-200">
            <FiBriefcase className="text-lg" />
            <span className="ml-3 hidden md:block">Projects</span>
          </a>
          <a href="#" className="flex items-center p-3 rounded-lg hover:bg-emerald-800/30 text-emerald-400 hover:text-emerald-200">
            <FaRegFileCode className="text-lg" />
            <span className="ml-3 hidden md:block">Skills</span>
          </a>
          <a href="#" className="flex items-center p-3 rounded-lg hover:bg-emerald-800/30 text-emerald-400 hover:text-emerald-200">
        ...
        <div className="mt-auto p-3">
          <a href="#" className="flex items-center 200 p-2 rounded-lg hover:bg-emerald-800/30 text-emerald-400 hover:text-emerald-200">
