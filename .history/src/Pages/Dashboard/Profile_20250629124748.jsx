...
<ul className='flex'>
  <li><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><FaLinkedin size={25} /></a> </li>
  <li><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><SiGmail size={25} /> </a></li>
</ul>
</div>
