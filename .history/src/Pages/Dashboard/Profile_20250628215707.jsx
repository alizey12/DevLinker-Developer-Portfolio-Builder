  ...
  return (
    <div className="flex flex-col md:flex-row gap-6">
      ...
      <div className="w-full md:w-1/3 bg-white p-6 rounded-lg shadow">
        ...
        <p  valueclassName="text-center text-gray-500">MERN Stack Developer</p>
        <p  valueclassName="text-center text-gray-500">Passionate MERN Stack developer crafting clean and user-focused web apps.</p>
