...
<ul className='flex'>
  <li><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><FaLinkedin  /></a> </li>
  <li><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><SiGmail  /> </a></li>
</ul>
</div>
