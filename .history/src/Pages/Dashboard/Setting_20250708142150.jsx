...
const Settings = () => {
  ...
  const accentColors = [
    { name: 'emerald', color: 'bg-emerald-500', text: 'text-emerald-500' },
    { name: 'blue', color: 'bg-blue-500', text: 'text-blue-500' },
    { name: 'purple', color: 'bg-purple-500', text: 'text-purple-500' },
    { name: 'rose', color: 'bg-rose-500', text: 'text-rose-500' },
    { name: 'amber', color: 'bg-amber-500', text: 'text-amber-500' },
