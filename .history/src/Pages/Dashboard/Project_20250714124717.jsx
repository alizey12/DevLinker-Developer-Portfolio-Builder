...
const Project = () => {
  ...
  const themeClasses = {
    ...
    text: {
      primary: theme === 'dark' ? 'text-emerald-100' : 'text-gray-800',
      secondary: theme === 'dark' ? 'text-gray-300' : 'text-emerald-600',
      accent: `text-${accentColor}-500`
    },
    card: theme === 'dark' 
      ? 'bg-emerald-800/50 border-emerald-700/50 hover:border-gray-600/50' 
      : 'bg-white border-gray-200 hover:border-gray-300 shadow-sm',
    sectionBorder: theme === 'dark' ? 'border-gray-700/50' : 'border-gray-200',
    tag: {
      react: theme === 'dark' 
                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-4">
                    <a 
                      ...
                      className={`flex items-center px-4 py-2 rounded-lg transition-colors ${themeClasses.button.primary}`}
                    >
