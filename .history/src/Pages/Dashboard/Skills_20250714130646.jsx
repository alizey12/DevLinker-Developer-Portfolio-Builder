        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className={`rounded-2xl p-6 border ${themeClasses.card}`}>
            ...
            <div className="space-y-6">
              <div className={`p-4 rounded-lg ${theme === 'dark' ? 'bg-emerald-700/20' : 'bg-gray-100'}`}>
          ...
          <div className={`rounded-2xl p-6 border ${themeClasses.card}`}>
            ...
            <div className="flex items-center justify-between mb-4">
              <div className={`p-3 rounded-lg ${theme === 'dark' ? 'bg-emerald-700/20' : 'bg-gray-100'}`}>
            ...
            <div className={`p-4 rounded-lg ${theme === 'dark' ? 'bg-emerald-900/30' : 'bg-gray-200'}`}>
