        ...
        <form className="space-y-4">
          <div>
            ...
            <input
              ...
              type="text"
              className="w-full border border-emerald-700 bg-white text-black p-2 rounded focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
            />
          </div>
          <div>
          ...
          <div>
            ...
            <input
              ...
              type="url"
              className="w-full border border-emerald-700 bg-white text-emerald-100 p-2 rounded focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
            />
          </div>
          <button
