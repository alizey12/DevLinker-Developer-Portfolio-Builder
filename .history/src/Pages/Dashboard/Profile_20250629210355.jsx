  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-emerald-100 mb-2">Developer Profile</h1>
        <p className="text-emerald-300 max-w-2xl mx-auto">Showcase your skills, experience, and personality to the world</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Profile Card */}
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-emerald-900/50 backdrop-blur-sm rounded-2xl p-6 border border-emerald-800/50 shadow-lg transition-all duration-500 hover:shadow-emerald-900/30 hover:border-emerald-600/50">
            <div className="flex flex-col items-center">
              ...
              <p className="text-emerald-400 font-medium">{savedProfile.title}</p>
              <p className="text-emerald-300 text-center mt-3">{savedProfile.bio}</p>
              <a 
            ...
            <div className="mt-8 pt-6 border-t border-emerald-800/50">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-emerald-950/50 p-4 rounded-xl text-center transition-all duration-300 hover:bg-emerald-900/70">
                  <p className="text-emerald-400 text-sm">Skills</p>
                  <p className="text-2xl font-bold text-emerald-200">12+</p>
                </div>
                <div className="bg-emerald-950/50 p-4 rounded-xl text-center transition-all duration-300 hover:bg-emerald-900/70">
                  <p className="text-emerald-400 text-sm">Projects</p>
                  <p className="text-2xl font-bold text-emerald-200">5+</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-emerald-800/50">
              ...
              <div className="flex justify-center space-x-6">
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="text-emerald-400 hover:text-emerald-300 transition-colors duration-300 transform hover:scale-110"
                >
                  <FaLinkedin size={24} />
                </a>
                <a 
