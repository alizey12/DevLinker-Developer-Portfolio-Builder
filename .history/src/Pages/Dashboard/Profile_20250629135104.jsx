      ...
      <h2 className="text-xl font-semibold mb-4">Edit Profile</h2>
        <form className="space-y-4">
          ...
          <div>
            ...
            <input value={formData.title} onChange={(e)=>setformData({...formData, name: e.target.value})} type="text" className="w-full border text-black p-2 rounded" />
          </div>
          <div>
            <label className="block  text-sm font-medium">Bio</label>
            <textarea value={formData.bio} onChange={(e)=>setformData({...formData, name: e.target.value})} className="w-full border p-2 rounded text-black"></textarea>
          </div>
          <div>
            <label className="block  text-sm font-medium">Website</label>
            <input value={formData.website} onChange={(e)=>setformData({...formData, name: e.target.value})} type="url" className="w-full border p-2 text-black rounded" />
          </div>
