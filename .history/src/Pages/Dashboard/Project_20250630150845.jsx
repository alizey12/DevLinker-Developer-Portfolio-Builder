    ...
    <div className="min-h-screen bg-emerald-900/70 backdrop-blur py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <section className="mb-20">
          <h2 className="text-2xl font-bold text-emerald-200 mb-8 pb-2 hover:bg-emerald-900 border-b border-emerald-800/50 flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {reactProjects.map((project, index) => (
              <div 
                key={index}
                className="bg-emerald-900/50 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-emerald-800/50 transition-all duration-300 hover:shadow-emerald-900/30 hover:border-emerald-600/50 hover:-translate-y-1"
              >
