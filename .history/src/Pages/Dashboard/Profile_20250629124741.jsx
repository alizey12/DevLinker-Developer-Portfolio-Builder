...
<ul className='flex'>
  <li><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><FaLinkedin size={20} /></a> </li>
  <li><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><SiGmail size={20} /> </a></li>
</ul>
</div>
