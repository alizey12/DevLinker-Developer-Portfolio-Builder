...
<ul className='flex'>
  <li className='p-4'><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><FaLinkedin size={25} /></a> </li>
  <li className='p-4'><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><SiGmail size={25} /> </a></li>
</ul>
</div>
