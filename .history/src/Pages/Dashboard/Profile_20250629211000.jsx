      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          <div className="bg-emerald-900/70 backdrop-blur-sm rounded-2xl p-6 border border-emerald-800/50 shadow-lg transition-all duration-500 hover:shadow-emerald-950 hover:bg-emerald-700 hover:border-emerald-600/50">
            ...
            {/* Stats */}
            <div className="mt-8 pt-6 border-t hover:bg-emerald-700   border-emerald-800/50">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-emerald-950/70 hover:bg-emerald-700 p-4 rounded-xl text-center transition-all duration-300 hover:bg-emerald-900/70">
