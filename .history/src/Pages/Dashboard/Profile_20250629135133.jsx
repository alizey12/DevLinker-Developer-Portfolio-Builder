  ...
  return (
    ...
    <div className="flex flex-col  md:flex-row gap-6">
      ...
      <div className="w-full md:w-1/2 bg-gray-900 text-white  p-6 rounded-lg shadow">
        ...
        <p  className="text-center text-white">{formData.title} </p>
        <h5  className="text-center text-slate-400">{formData.bio} </h5>
        <p  className="text-center text-white">{formData.website} </p>
