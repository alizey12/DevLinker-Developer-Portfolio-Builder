      ...
      <div className="w-full md:w-2/3 bg-white p-6 rounded-lg shadow">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input value={formData.va} onChange={(e)=>handleInput(e.target.value)} type="text" className="w-full border p-2 rounded" />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea value={formData.va} onChange={(e)=>handleInput(e.target.value)} className="w-full border p-2 rounded"></textarea>
          </div>
          <div>
            <label className="block text-sm font-medium">Website</label>
            <input value={formData.va} onChange={(e)=>handleInput(e.target.value)} type="url" className="w-full border p-2 rounded" />
          </div>
          <button onsu className="bg-blue-600 text-white px-4 py-2 rounded">Save Changes</button>
        </form>
      </div>
    </div>
  )
