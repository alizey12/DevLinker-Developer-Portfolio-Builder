...
<ul className='flex'>
  <li><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><FaLinkedin /> </li>
  <li><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><SiGmail /> </li>
</ul>
</div>
