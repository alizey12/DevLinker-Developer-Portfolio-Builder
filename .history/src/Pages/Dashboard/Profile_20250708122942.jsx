...
const Skills = () => {
  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Next.js", level: 75, icon: <DiReact className="text-gray-100" /> }
      ]
    },
    {
  ...
  const languages = [
    ...
    { name: "Python", value: 5, color: "text-emerald-400" },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-950 to-emerald-900 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-emerald-900/50 backdrop-blur-sm rounded-2xl p-6 border border-emerald-800/50 shadow-lg">
            ...
            <div className="space-y-6">
              <div className="p-4 bg-emerald-800/20 rounded-lg">
                <h3 className="text-emerald-400 mb-2">Years Coding</h3>
                <div className="text-5xl font-bold text-emerald-100">1+</div>
              </div>
              <div className="p-4 bg-emerald-800/20 rounded-lg">
                <h3 className="text-emerald-400 mb-2">Projects Completed</h3>
                <div className="text-5xl font-bold text-emerald-100">6+</div>
              </div>
              <div className="p-4 bg-emerald-800/20 rounded-lg">
          ...
          <div className="bg-emerald-900/50 backdrop-blur-sm rounded-2xl p-6 border border-emerald-800/50 shadow-lg">
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="p-3 bg-emerald-800/20 rounded-lg">
        ...
        <div className="space-y-12">
          {skillCategories.map((category, index) => (
            <div key={index} className="bg-emerald-900/50 backdrop-blur-sm rounded-2xl overflow-hidden shadow-lg border border-emerald-800/50 transition-all hover:border-emerald-600/50">
