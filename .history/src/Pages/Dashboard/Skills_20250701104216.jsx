    ...
    <div className="min-h-screen bg-emerald-950 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          {/* GitHub Stats */}
          <div className="bg-emerald-900/50 backdrop-blur-sm rounded-2xl p-6 border border-emerald-800/50 shadow-lg">
            <h2 className="text-xl font-bold text-emerald-200 mb-6">Github</h2>
            ...
            <a 
              href='            <h2 className="text-xl font-bold text-emerald-200 mb-6"><a href='https://github.com/alizey12' >NavLink</a> </h2>
' 
