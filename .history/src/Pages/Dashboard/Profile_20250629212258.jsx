...
const Profile = () => {
  ...
  const testimonials = [
    {
      quote: "Kinza delivered exceptional work on our e-commerce project. Her attention to detail is remarkable.",
      author: "Alex Johnson",
      role: "CEO, TechSolutions"
    },
    {
      quote: "Working with Kinza was a pleasure. She transformed our vague ideas into a beautiful, functional product.",
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* About Card */}
          <div className="bg-emerald-900/70 backdrop-blur-sm rounded-2xl p-6 border border-emerald-800/50  shadow-lg transition-all duration-500 hover:bg-emerald-700 hover:shadow-emerald-900/30">
          ...
          {/* Badges & Tags */}
          <div className="bg-emerald-900/70 backdrop-blur-sm rounded-2xl p-6 border hover:bg-emerald-700 border-emerald-800/50 shadow-lg transition-all duration-500 hover:shadow-emerald-900/30">
          ...
          {/* Testimonials */}
          <div className="bg-emerald-900/70 w-1/3 backdrop-blur-sm rounded-2xl p-6 border border-emerald-800/50 shadow-lg transition-all duration-500 hover:bg-emerald-700 hover:shadow-emerald-900/30">
            <h2 className="text-2xl font-bold text-emerald-100 mb-6">Client Testimonials</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-emerald-950/30 p-6 rounded-xl border border-emerald-800/50 transition-all duration-300 hover:border-emerald-600/50">
                  <p className="italic text-emerald-200 mb-4">"{testimonial.quote}"</p>
                  <div className="flex items-center">
                    <div className="w-10 h-10 rounded-full bg-emerald-700/50 flex items-center justify-center mr-4">
                      <span className="text-emerald-300 text-lg">{testimonial.author.charAt(0)}</span>
                    </div>
                    <div>
