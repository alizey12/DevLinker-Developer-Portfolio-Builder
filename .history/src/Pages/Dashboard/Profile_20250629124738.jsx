...
<ul className='flex'>
  <li><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><FaLinkedin size={} /></a> </li>
  <li><a href="mailto:example@example.com" target="_blank" rel="noopener noreferrer"><SiGmail size={} /> </a></li>
</ul>
</div>
