      ...
      <div className="w-full md:w-2/3 bg-white p-6 rounded-lg shadow">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input onChange={(e)=>setFormData} type="text" className="w-full border p-2 rounded" />
          </div>
          <div>
          ...
          <div>
            ...
            <textarea onChange={(e)=>setFormData} className="w-full border p-2 rounded"></textarea>
          </div>
          <div>
            <label className="block text-sm font-medium">Website</label>
            <input onChange={(e)=>setFormData} type="url" className="w-full border p-2 rounded" />
          </div>
