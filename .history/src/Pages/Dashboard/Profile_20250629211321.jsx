    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* About Card */}
          <div className="bg-emerald-900/70 backdrop-blur-sm rounded-2xl p-6 border border-emerald-800/50 border-emerald-800/50 shadow-lg transition-all duration-500 hover:shadow-emerald-900/30">
