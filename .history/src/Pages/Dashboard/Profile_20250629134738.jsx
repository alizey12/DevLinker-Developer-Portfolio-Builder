  ...
  return (
    ...
    <div className="flex flex-col  md:flex-row gap-6">
      ...
      <div className="w-full md:w-1/2 bg-gray-900 text-white  p-6 rounded-lg shadow">
        ...
        />
        <h2 className="text-center text-xl font-semibold mt-4">{formData.name}  </h2>
      ...
      <h2 className="text-xl font-semibold mb-4">Edit Profile</h2>
        <form className="space-y-4">
          <div>
            ...
            <input value={formData.name} onChange={{...formData, name: e.target.value}} type="text" className="w-full border text-black p-2 rounded" />
          </div>
          <div>
