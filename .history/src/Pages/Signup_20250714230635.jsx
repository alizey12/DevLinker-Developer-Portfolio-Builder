        ...
        <div className="p-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center">
                  <input
                    ...
                    className={`h-4 w-4 text-${accentColor}-600 focus:ring-${accentColor}-500 ${theme === 'dark' ? 'border-gray-600 bg-gray-700/50' : 'border-gray-300 bg-gray-50'}`}
                  />
                  <label htmlFor="male" className={`ml-2 block text-sm ${themeClasses.text.secondary}`}>
                    Male
                  </label>
                </div>
                <div className="flex items-center">
                  <input
                    ...
                    className={`h-4 w-4 text-${accentColor}-600 focus:ring-${accentColor}-500 ${theme === 'dark' ? 'border-gray-600 bg-gray-700/50' : 'border-gray-300 bg-gray-50'}`}
                  />
                  <label htmlFor="female" className={`ml-2 block text-sm ${themeClasses.text.secondary}`}>
                    Female
                  </label>
                </div>
              </div>
            ...
            <label className="flex items-start">
              <input
                type="checkbox"
                className={`mt-1 rounded-sm ${theme === 'dark' ? 'bg-gray-700/50 border-gray-600' : 'bg-gray-50 border-gray-300'} text-${accentColor}-600 focus:ring-${accentColor}-500`}
              />
