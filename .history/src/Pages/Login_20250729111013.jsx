...
const Login = () => {
  ...
  const themeClasses = {
    ...
    button: {
      primary: `bg-${accentColor}-600 hover:bg-${accentColor}-500 ${theme === 'dark' ? 'text-white' hover:: 'text-emerald-300 hover:text-emerald-800'} transition-all duration-300 transform hover:scale-105`,
    }
  };
