...
Add these CSS variables to your root CSS file:

css
:root {
  /* Default emerald colors */
  --color-primary: var(--color-emerald-500);
  --color-primary-light: var(--color-emerald-400);
...
Would you like me to adapt any other specific components or provide more detailed examples for particular sections?

give me full corrected skills and dashboard pages
Here are the fully corrected Skills and Dashboard pages with complete theme integration:

1. Updated Skills Page (Skills.jsx)
jsx
...
const Skills = () => {
  ...
  const themeClasses = {
    bg: theme === 'dark' ? 'bg-gradient-to-br from-gray-900 to-gray-800' : 'bg-gray-50',
    text: {
